...
3. barcode: 12-digit UPC or 13-digit EAN code read from the packaging barcode digits, or null if absent.
4. category: "Produce", "Dairy & Eggs", "Meat & Seafood", "Bakery", "Beverages", "Condiments", "Pantry Staples", "Frozen Meals", or "Snacks".
5. quantity: Number extracted from packaging/receipt or visual estimation.
6. unit: "pcs", "pack", "carton", "bottle", "can", "box", "bag", "lbs", "oz", "fl oz", "kg", "g", "L", "gal".
7. recommendedLocation: "Fridge", "Pantry", or "Freezer".
8. storageReason: Why this compartment is recommended.
9. estimatedShelfLifeDays: Days before spoilage. If printed expiration date is detected, use the remaining days until that date.
10. monthsFrozenShelfLife: Recommended maximum frozen storage duration in months if frozen at 0°F (-18°C).
11. confidence: 0.0 to 1.0.
12. storageTip: Practical tip to maximize freshness.
13. detectedText: Key printed label or receipt text read via OCR.
14. printedExpirationDate: Date string (preferably YYYY-MM-DD) if stamped on packaging, else null.
