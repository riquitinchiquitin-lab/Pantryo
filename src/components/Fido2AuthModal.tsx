                ...
                <form onSubmit={handleConfirmTotp} className="space-y-3 animate-fade-in">
                  ...
                  <div className="p-3.5 rounded-2xl bg-white border border-[#E0D9C8] space-y-2">
                    <label className="block text-[11px] font-bold text-[#0D3B37]">
                      {lang === 'FR'
                        ? '2. Entrez le code à 6 chiffres généré par votre application d’authentification :'
                        : '2. Enter the 6-digit code generated by your authenticator app:'}
                    </label>
                    <p className="text-[10px] text-[#527470]">
                      {lang === 'FR'
                        ? 'Ouvrez votre application (Google Authenticator, Microsoft Authenticator) et saisissez le code temporaire pour valider.'
                        : 'Open your authenticator app (Google Authenticator, Microsoft Authenticator) and enter the temporary code to confirm.'}
                    </p>
                    <input
                      type="text"
                      maxLength={6}
                  ...
                  {fido2Status && !fido2Status.totpEnabled && totpSetupData && (
                    <form onSubmit={handleConfirmTotp} className="p-4 rounded-2xl bg-white border border-[#E0D9C8] space-y-3 animate-fade-in">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-[10px] text-[#527470]">
                          {lang === 'FR'
                            ? 'Consultez votre application d’authentification pour obtenir le code temporaire.'
                            : 'Check your authenticator app to get the temporary 6-digit code.'}
                        </p>
                        <input
                          type="text"
                          maxLength={6}
