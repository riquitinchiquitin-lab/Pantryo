            ...
            <form onSubmit={handleConfirmTotpSetup} className="space-y-3">
              ...
              <div className="p-3.5 rounded-2xl bg-white border border-[#E0D9C8] space-y-2">
                ...
                <p className="text-[10px] text-[#527470]">
                  {lang === 'FR'
                    ? 'Ouvrez Google Authenticator ou Microsoft Authenticator et saisissez le code temporaire.'
                    : 'Open Google Authenticator or Microsoft Authenticator and enter the temporary code.'}
                </p>
                <input
                  type="text"
                  maxLength={6}
